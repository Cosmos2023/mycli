...
const SOURCE_URL = new URL("../src/pi-ai-model.ts", import.meta.url).href;
const DIRECTORY_SOURCE_URL = new URL("../src/provider-directory.ts", import.meta.url).href;
const REGISTRY_SOURCE_URL = new URL("../src/provider-registry.ts", import.meta.url).href;
