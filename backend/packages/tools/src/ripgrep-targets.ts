...
export const RIPGREP_TARGETS = Object.freeze({
	"macos-aarch64": Object.freeze({
		...
		npmPackage: "@cosmos2023/ripgrep-darwin-arm64",
		npmCpu: "arm64",
		npmOs: "darwin",
	...
	"macos-x86_64": Object.freeze({
		...
		npmPackage: "@cosmos2023/ripgrep-darwin-x64",
		npmCpu: "x64",
		npmOs: "darwin",
	...
	"linux-aarch64": Object.freeze({
		...
		npmPackage: "@cosmos2023/ripgrep-linux-arm64",
		npmCpu: "arm64",
		npmOs: "linux",
	...
	"linux-x86_64": Object.freeze({
		...
		npmPackage: "@cosmos2023/ripgrep-linux-x64",
		npmCpu: "x64",
		npmOs: "linux",
	...
	"windows-aarch64": Object.freeze({
		...
		npmPackage: "@cosmos2023/ripgrep-win32-arm64",
		npmCpu: "arm64",
		npmOs: "win32",
	...
	"windows-x86_64": Object.freeze({
		...
		npmPackage: "@cosmos2023/ripgrep-win32-x64",
		npmCpu: "x64",
		npmOs: "win32",
