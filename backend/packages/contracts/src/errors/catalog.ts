...
export const ERROR_DEFINITIONS = Object.freeze({
	...
	"provider.output_limit": define("The response reached its output token limit before completion.", "provider", ["inspect_configuration"], "provider_error"),
	"provider.empty_response": define("The provider returned no answer or tool call.", "provider", ["retry", "select_compatible_model"], "provider_error"),
	...
	"runtime.compaction_summary_too_long": define("The compaction summary exceeded its length limit. The original conversation was kept.", "runtime", ["select_compatible_model"], "provider_error", RUNTIME),
