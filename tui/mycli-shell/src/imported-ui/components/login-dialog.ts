import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@earendil../../adapters/mycli-ai-oauth.ts";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@earendil../../tui-core/index.ts";
