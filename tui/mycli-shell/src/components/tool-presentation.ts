...
const TOOL_PRESENTATIONS: Record<string, Partial<ToolPresentation>> = {
	...
	shell: { label: "Bash", accent: "bashMode", terminalPreviewLines: 14, alwaysShowDetails: true },
	run_shell: { label: "Bash", accent: "bashMode", terminalPreviewLines: 14, alwaysShowDetails: true },
