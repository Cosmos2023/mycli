...
const TOOL_PRESENTATIONS: Record<string, Partial<ToolPresentation>> = {
	bash: { label: "Bash", accent: "bashMode", terminalPreviewLines: 5 },
	shell: { label: "Shell", accent: "bashMode", terminalPreviewLines: 5 },
	run_shell: { label: "Shell", accent: "bashMode", terminalPreviewLines: 5 },
